...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Codex07",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Codex07.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Codex07 Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Codex07.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Codex07.",
  ...
  "dialog.server.description": "Switch which Codex07 server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Codex07",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Codex07...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Codex07 in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Codex07...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Codex07 in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Codex07 in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Codex07",
  "wsl.onboarding.opencodeReadyIn": "Codex07 is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codex07 is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Codex07 in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Codex07",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codex07 not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Codex07 can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Codex07 could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Codex07.",
  ...
  "help.tabs.introduction": "Codex07 is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Codex07 ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Codex07 team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Codex07 does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Codex07 includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Codex07 server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Codex07",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Codex07 looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Codex07 follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Codex07 is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Codex07 launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Codex07.",
